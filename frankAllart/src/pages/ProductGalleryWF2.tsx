...
const ProductGalleryWF2: React.FC = () => {
  ...
  <a><IonIcon slot="icon-only" src="assets/icon/share-social-outline.svg"/>Share Now</a>*/}
      ...
      <IonContent fullscreen>
        ...
        <IonThumbnail id="productGalleryTitleImg">
          <IonImg src="assets/menu-images/WF.png"/>
        </IonThumbnail>
        <IonLabel><p>WF2</p></IonLabel>
        <IonLabel><p>20 Photos</p></IonLabel>
        </IonList>
        <IonList id="productGalleryls">
        {ProductImages.filter((pi) => pi.pageName === 'WF2').map( pi => <ProductImagesItem key={pi.id} productImages={pi} />)}
        </IonList>
      </IonContent>
    </IonPage>
  );
...
export default ProductGalleryWF2;
