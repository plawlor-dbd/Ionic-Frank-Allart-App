...
const ProductGalleryST6: React.FC = () => {
  ...
  <a><IonIcon slot="icon-only" src="assets/icon/share-social-outline.svg"/>Share Now</a>*/}
      ...
      <IonContent fullscreen>
        ...
        <IonLabel><p>ST6</p></IonLabel>
        <IonLabel><p>7 Photos</p></IonLabel>
        </IonList>
        <IonList id="productGalleryls">
        {ProductImages.filter((pi) => pi.pageName === 'ST6').map( pi => <ProductImagesItem key={pi.id} productImages={pi} />)}
...
export default ProductGalleryST6;
