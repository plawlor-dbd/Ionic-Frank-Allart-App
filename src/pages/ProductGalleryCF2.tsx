...
const ProductGalleryCF2: React.FC = () => {
    ...
    <IonPage id="product-gallery">
      <IonHeader>
        ...
        <IonButtons  slot="start">
          <IonButton routerLink="/home/CabinetFurniture">
            <IonIcon slot="icon-only" src="assets/icon/chevron-back-outline.svg"/>
            </IonButton>
        </IonButtons>
          <IonTitle>CF2</IonTitle>
          <IonButtons slot="end">
  ...
  <a><IonIcon slot="icon-only" src="assets/icon/share-social-outline.svg"/>Share Now</a>*/}
      ...
      <IonContent fullscreen>
        ...
        <IonLabel><p>CF2</p></IonLabel>
        <IonLabel><p>6 Photos</p></IonLabel>
        </IonList>
        <IonList id="productGalleryls">
        {ProductImages.filter((pi) => pi.pageName === 'CF2').map( pi => <ProductImagesItem key={pi.id} productImages={pi} />)}
        </IonList>
      </IonContent>
    </IonPage>
  );
...
export default ProductGalleryCF2;
