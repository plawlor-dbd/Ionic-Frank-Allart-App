...
const ProductGalleryCF1: React.FC = () => {
  ...
  <a><IonIcon slot="icon-only" src="assets/icon/share-social-outline.svg"/>Share Now</a>*/}
      ...
      <IonContent>
        ...
        <IonLabel><p>CF1</p></IonLabel>
        <IonLabel><p>10 Photos</p></IonLabel>
        </IonList>
        <IonList id="productGalleryls">
        {ProductImages.filter((pi) => pi.pageName === 'CF1').map( pi => <ProductImagesItem key={pi.id} productImages={pi} />)}
        </IonList>
      </IonContent>
    </IonPage>
  );
...
export default ProductGalleryCF1;
