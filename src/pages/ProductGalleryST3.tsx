...
const ProductGalleryST3: React.FC = () => {
  ...
  <a><IonIcon slot="icon-only" src="assets/icon/share-social-outline.svg"/>Share Now</a>*/}
      ...
      <IonContent fullscreen>
        ...
        <IonLabel><p>ST3</p></IonLabel>
        <IonLabel><p>4 Photos</p></IonLabel>
        </IonList>
        <IonList id="productGalleryls">
        {ProductImages.filter((pi) => pi.pageName === 'ST3').map( pi => <ProductImagesItem key={pi.id} productImages={pi} />)}
...
export default ProductGalleryST3;
