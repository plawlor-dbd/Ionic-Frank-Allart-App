...
const ProductGalleryDF3: React.FC = () => {
  ...
  <a><IonIcon slot="icon-only" src="assets/icon/share-social-outline.svg"/>Share Now</a>*/}
      ...
      <IonContent fullscreen>
        ...
        <IonThumbnail id="productGalleryTitleImg">
          <IonImg src="assets/menu-images/DF.png"/>
        </IonThumbnail>
        <IonLabel><p>DF3</p></IonLabel>
        <IonLabel><p>16 Photos</p></IonLabel>
        </IonList>
        <IonList id="productGalleryls">
        {ProductImages.filter((pi) => pi.pageName === 'DF3').map( pi => <ProductImagesItem key={pi.id} productImages={pi} />)}
...
export default ProductGalleryDF3;
