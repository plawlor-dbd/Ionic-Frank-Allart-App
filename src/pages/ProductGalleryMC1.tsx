...
const ProductGalleryMC1: React.FC = () => {
  ...
  <a><IonIcon slot="icon-only" src="assets/icon/share-social-outline.svg"/>Share Now</a>*/}
      ...
      <IonContent fullscreen>
        ...
        <IonLabel><p>MC1</p></IonLabel>
        <IonLabel><p>4 Photos</p></IonLabel>
        </IonList>
        <IonList id="productGalleryls">
        {ProductImages.filter((pi) => pi.pageName === 'MC1').map( pi => <ProductImagesItem key={pi.id} productImages={pi} />)}
        </IonList>
      </IonContent>
    </IonPage>
  );
...
export default ProductGalleryMC1;
