...
const ProductGalleryDB3: React.FC = () => {
    ...
    <IonPage id="product-gallery">
      <IonHeader>
        ...
        <IonButtons  slot="start">
          <IonButton routerLink="/home/DoorBoltsandCremone">
            <IonIcon slot="icon-only" src="assets/icon/chevron-back-outline.svg"/>
            </IonButton>
        </IonButtons>
          <IonTitle>DB3</IonTitle>
          <IonButtons slot="end">
  ...
  <a><IonIcon slot="icon-only" src="assets/icon/share-social-outline.svg"/>Share Now</a>*/}
      ...
      <IonContent fullscreen>
        ...
        <IonThumbnail id="productGalleryTitleImg">
          <IonImg src="assets/menu-images/DB.png"/>
        </IonThumbnail>
        <IonLabel><p>DB3</p></IonLabel>
        <IonLabel><p>20 Photos</p></IonLabel>
        </IonList>
        <IonList id="productGalleryls">
        {ProductImages.filter((pi) => pi.pageName === 'DB3').map( pi => <ProductImagesItem key={pi.id} productImages={pi} />)}
        </IonList>
      </IonContent>
    </IonPage>
  );
...
export default ProductGalleryDB3;
