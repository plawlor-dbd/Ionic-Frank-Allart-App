...
const ProductGalleryDF6: React.FC = () => {
  ...
  <a><IonIcon slot="icon-only" src="assets/icon/share-social-outline.svg"/>Share Now</a>*/}
      ...
      <IonContent fullscreen>
        ...
        <IonLabel><p>DF6</p></IonLabel>
        <IonLabel><p>15 Photos</p></IonLabel>
        </IonList>
        <IonList id="productGalleryls">
        {ProductImages.filter((pi) => pi.pageName === 'DF6').map( pi => <ProductImagesItem key={pi.id} productImages={pi} />)}
...
export default ProductGalleryDF6;
