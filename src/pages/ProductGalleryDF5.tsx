...
const ProductGalleryDF5: React.FC = () => {
  ...
  <a><IonIcon slot="icon-only" src="assets/icon/share-social-outline.svg"/>Share Now</a>*/}
      ...
      <IonContent fullscreen>
        ...
        <IonLabel><p>DF5</p></IonLabel>
        <IonLabel><p>20 Photos</p></IonLabel>
        </IonList>
        <IonList id="productGalleryls">
        {ProductImages.filter((pi) => pi.pageName === 'DF5').map( pi => <ProductImagesItem key={pi.id} productImages={pi} />)}
...
export default ProductGalleryDF5;
